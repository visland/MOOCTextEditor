...
public class NearbyWords implements SpellingSuggest {
  ...
  public List<String> suggestions(String word, int numSuggestions) {
    ...
    while (!queue.isEmpty() && retList.size() < numSuggestions && visited.size() < THRESHOLD) {
      ...
      List<String> listDistanceOne = distanceOne(curr, true);
      for (String s : listDistanceOne) {
        if (!visited.contains(s)) {
          visited.add(s);
          queue.add(s);
          if (dict.isWord(s) && retList.size() < numSuggestions) {
            retList.add(s);
          }
        }
      }
  ...
  public static void main(String[] args) {
     ...
     */
    String word = "shit"; // Pass NearbyWords any Dictionary implementation you prefer
